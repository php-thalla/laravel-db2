...
namespace PhpThalla\DB2\Database;

use PDO;

use Illuminate\Database\Connection;

use PhpThalla\DB2\Database\Schema\Builder;
use PhpThalla\DB2\Database\Query\Processors\DB2Processor;
use PhpThalla\DB2\Database\Query\Processors\DB2ZOSProcessor;
use PhpThalla\DB2\Database\Query\Grammars\DB2Grammar as QueryGrammar;
use PhpThalla\DB2\Database\Schema\Grammars\DB2Grammar as SchemaGrammar;
use PhpThalla\DB2\Database\Schema\Grammars\DB2ExpressCGrammar;

/**
 * Class DB2Connection
 *
 * @package PhpThalla\DB2\Database
 */
class DB2Connection extends Connection
{
     ...
     *
     * @return \PhpThalla\DB2\Database\Schema\Builder
     */
     ...
     *
     * @return \PhpThalla\DB2\Database\Query\Processors\DB2Processor|\PhpThalla\DB2\Database\Query\Processors\DB2ZOSProcessor
     */
