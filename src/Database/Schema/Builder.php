...
namespace PhpThalla\DB2\Database\Schema;
 ...
 * Class Builder
 *
 * @package PhpThalla\DB2\Database\Schema
 */
class Builder extends \Illuminate\Database\Schema\Builder
{
     ...
     *
     * @return \PhpThalla\DB2\Database\Schema\Blueprint
     */
    protected function createBlueprint($table, Closure $callback = null)
    {
        ...
        return new \PhpThalla\DB2\Database\Schema\Blueprint($table, $callback);
    }
}
